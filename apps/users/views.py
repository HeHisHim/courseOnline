...
class RegisterView(View):
    ...
    def post(self, request):
        ...
        if register_form.is_valid():
            ...
            send_register_mail(username, "register")
...
class UserinfoView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if user_info_form.is_valid():
            ...
            return JsonResponse(json.dumps(user_info_form.errors), safe=False)
...
class UpdatePwdView(LoginRequiredMixin, View):
    ...
    def post(self, request):
        ...
        if modify_form.is_valid():
            ...
            pwd2 = request.POST.get("password2", "")
            if pwd1 != pwd2:
                return JsonResponse({"ststus": "fail", "msg": "密码不一致"})
...
class SendEmailCodeView(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        send_register_mail(email, "update")
...
class MyFacOrgView(LoginRequiredMixin, View):
    """我收藏的课程机构"""
    def get(self, request):
        org_list = []
