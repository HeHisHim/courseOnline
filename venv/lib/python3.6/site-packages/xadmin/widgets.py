...
class AdminSplitDateTime(forms.SplitDateTimeWidget):
    ...
    def render(self, name, value, attrs=None):
        ...
        my_hts = list(super(AdminSplitDateTime, self).render(name, value, attrs).strip().split(">"))

        input_html = [ht for ht in my_hts if ht != '']
        # return input_html
        for key, value in enumerate(input_html):
            input_html[key] += ">"
